...
const serviceList = ["audireai", "assemblyai", "aws", "google", "ibm", "microsoft", "whisper", "speechmatics", "deepgram"];
    ...
    switch (commandLine.length) {
        ...
        case 4:
            ...
            if (serviceList.indexOf(commandLine[0].toLowerCase()) == -1) {
                throw new Error("Service parameter is not a member of the current list: (AudireAI, AssemblyAI, AWS, Google, IBM, Microsoft, Deepgram, Speechmatics, Whisper)");
            }
